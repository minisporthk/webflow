// General Use Case: Disable venues from venue dropdown based on the program selected

// Disable some of the venue options that is not applicable to Winter Camps
